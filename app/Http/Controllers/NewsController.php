...
class NewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('news.index')->with([Alert::Success('Success', 'Message Success')]);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('news.index')->with([Alert::Success('Success', 'Berhasil dihapus')]);
    }
