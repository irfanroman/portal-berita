...
@section('content')
    <h3 class="category-title">Berita Zeinn</h3>
    <div class="col-12">
    ...
    @forelse ($news as $row)
        <div class="d-md-flex post-entry-2 small-img">
            ...
            <div>
                <div class="post-meta"><span cla4ss="date">{{ $row->category->name }}</span> <span
                ...
                <div class="d-flex align-items-center author">
                    <div class="photo"><img src="{{ url('frontend/assets/img/person-2.jpg') }}" alt=""
                            class="img-fluid"></div>
                    <div class="name">
