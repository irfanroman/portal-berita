...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">News Slider</h5>

            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ 'home' }}"><i class="bi bi-house-door"></i></a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('slider.index') }}"></a>Slider</li>
                </ol>
            </nav>
            @if ($errors->any())
            ...
            <tbody>
                @foreach ($slider as $row)
                    <tr>
                        ...
                        <td>
                            <a href="http://{{ $row->url }}" target="_blank" rel="noopener noreferrer">Link</a>
                        </td>
                        <td>
